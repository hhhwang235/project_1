...
<div class="box1">
	...
	<%
		...
		try {
			// 쿼리 준비			
			String query = "select * from NO_GOODS";
			// 커넥션 객체 생성
	...
	<tr style = "background-color:skyblue;">
		<td>차량명</td><td>재고 댓수</td><td>보관 장소</td>
	</tr>
	<%
	while(rs.next()) {
	%>
					<td><%= rs.getString("productions") %></td>
					<td><%= rs.getString("NO_Product_quantity") %></td>
