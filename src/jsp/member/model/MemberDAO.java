...
public class MemberDAO 
{
    ...
    public MemberBean getUserInfo(String id) 
    {
        ...
        try {
            ...
            query.append("SELECT * FROM MEMBERS WHERE USER_ID=?");
    ...
    public ArrayList<MemberBean> getMemberList()
    {
        ...
        try {
            StringBuffer query = new StringBuffer();
            query.append("SELECT * FROM MEMBERS");
    ...
    public void updateMember(MemberBean member) throws SQLException{
        ...
        try {
            ...
            query.append(" PWD=?, EMAIL=?, PHONE=?, ADDRESS=?");
    ...
    public int deleteMember(String id, String pw) 
    {
        ...
        try {
            ...
            query1.append("SELECT PWD FROM MEMBERS WHERE USER_ID=?");
 
            // 회원 삭제
            StringBuffer query2 = new StringBuffer();
            query2.append("DELETE FROM MEMBERS WHERE USER_ID=?");
    ...
    public int loginCheck(String id, String pw) 
    {
        ...
        try {
            ...
            StringBuffer query = new StringBuffer();
            query.append("SELECT PWD FROM MEMBERS WHERE USER_ID=?");
    ...
    public boolean duplicateIdCheck(String id)
    {
        ...
        try {
            // 쿼리
            StringBuffer query = new StringBuffer();
            query.append("SELECT USER_ID FROM MEMBERS WHERE USER_ID=?");
